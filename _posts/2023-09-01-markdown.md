---
layout: single
title:  "Jekyll Github 블로그 마크다운(Markdown) 문법 정리"
categories: [blog, jekyll, Jekyll, Markdown]
tag: [blog, jekyll, github, Jekyll, Markdown]
...
![image](https://motionarray.imgix.net/preview-982937-sJEF0zzx9j4PsS9g-large.jpg?w=660&q=60&fit=max&auto=format){: width="70%" height="70%"}{: .align-center}

*사진 출처 : https://motionarray.com/stock-photos/villiage-in-swiss-alps-982937/?subcategories=free,nature-outdoors*
...
<br>
    ...
    출처: https://ansohxxn.github.io/categories/blog
    연습용으로 제작하고 있습니다.
    문제가 있거나 발견되면 댓글로 남겨주시면 처리하겠습니다.
    감사합니다.
